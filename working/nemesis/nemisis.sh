...
greeting() {
    yad --width=600 --height=400 --center --title="$title" --image="crosshairs.png" --image-on-top --text="<big>Welcome to the Nemesis Installer</big>\n\n\n" --form --field=" ":LBL --image-on-top --field="Thank you for Choosing a Revenge OS System. Click Okay to Get Started":LBL > answer.txt
...
partitions() {
    yad --width=600 --height=400 --center --title="$title" --text="Partitions" --text="<big>Partitioning</big>\n\nHow Would You Like to Partition Your Disk? Auto Partitioning will delete everything on the disk and install Revenge OS\n\nManual Partitioning will allow you to create and edit partitions and choose where to install Revenge OS" --image="obr-logo-sm.png" --radiolist --list --column="Select" --column="Type" false "Automatic Partioning" false "Manual Partitioning" --separator=" " > answer.txt   
...
config1(){
    ...
    yad --width=600 --height=400 --center --title="$title" --image="obr-logo-sm.png" --text "Configuration" --form --field="Select Your Keyboard Layout:":CB --field="Select Your locale:":CB --field="Select Your Region:":CB --separator=" " \
...
config2() {
    ...
    yad --width=600 --height=400 --center --title="$title" --image="obr-logo-sm.png" --text "Configuration" --form --field="Select your sub-zone:":CB --field="Use UTC or Local Time?":CB --field="Choose a hostname:" --field="Choose a username:" --field="Enter Your User Password:H" --field="Re-enter Your User Password:H" --separator=" " \
...
desktop() {
    desktops=$(yad --width=600 --height=400 --center --title="$title" --text="Desktops" --text="<big>Desktops</big>\n\nWhich Revenge OS Desktop would you like to install?" --image="obr-logo-sm.png" --radiolist --list --column="Select" --column="Desktop" false "OBR Openbox" false "Gnome" false "Plasma" false "XFCE" false "Mate" false "i3" --separator=" ")
    echo $desktops
...
confirm() {
    yad --width=600 --height=400 --center --info --title="$title" --text="You have chosen the following:\n\n$part partitioning\n\nkeyboard layout: $key\n\nTimezone: $zone $subzone\n\nHostname: $hname\n\nUsername: $username\n\nClock configuration: $clock\n\nDesktop: $desktop"
